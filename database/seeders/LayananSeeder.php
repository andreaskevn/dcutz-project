...
class LayananSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $layanans = [
            ...
            [
                'id' => Str::uuid(),
                'nama_layanan' => 'Haircut by Agis (pilih sesuai kapster)',
                'harga_layanan' => 70000,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => Str::uuid(),
                'nama_layanan' => 'Haircut by Heru (pilih sesuai kapster)',
                'harga_layanan' => 60000,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => Str::uuid(),
                'nama_layanan' => 'Haircut by Akbar (pilih sesuai kapster)',
                'harga_layanan' => 60000,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => Str::uuid(),
                'nama_layanan' => 'Haircut by Rohman (pilih sesuai kapster)',
                'harga_layanan' => 60000,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'id' => Str::uuid(),
                'nama_layanan' => 'Haircut by Jack (pilih sesuai kapster)',
                'harga_layanan' => 60000,
                'created_at' => now(),
                'updated_at' => now(),
            ],
