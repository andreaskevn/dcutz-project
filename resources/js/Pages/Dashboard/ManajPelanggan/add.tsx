...
export default function CreatePelanggan({ pelanggans }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const toastId = toast.loading("Adding customers...");

        post(route("pelanggan.store"), {
            onSuccess: () => {
                toast.dismiss(toastId);
                toast.success("Successfully adding customers");
                resetForm();
            },
            onError: (errors) => {
                toast.dismiss(toastId);
                toast.error("Failed adding customers");
        ...
        <Layout>
            ...
            <div className="py-10 px-6">
                <Card className="shadow-md border border-solid">
                    <CardHeader>
                        <CardTitle className="text-xl font-semibold">Tambah Pelanggan Baru</CardTitle>
                    </CardHeader>
